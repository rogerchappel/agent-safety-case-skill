...
Draft reviewable safety cases before agent side effects. Agent workflows need small, inspectable artifacts that can be reviewed before reuse or approval.
